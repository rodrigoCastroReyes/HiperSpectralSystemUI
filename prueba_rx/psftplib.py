...
class SFTP:
    ...
    def login(self, username=None, password=None):
        ...
        prompt_found = timeout(self._wait_for_text, args=(username_prompt,), timeout_duration=PROCESS_TIMEOUT_SEC,
                               default=False)
        ...
        if prompt_found:
            ...
            # Wait for the username login prompt
            # --> use timeout on wait4prompt function
            prompt_found = timeout(self._wait_for_text, args=(password_prompt,), timeout_duration=PROCESS_TIMEOUT_SEC,
                                   default=False)
            ...
            if prompt_found:
                ...
                # --> use timeout on wait4prompt function
                prompt_found = timeout(self._wait_for_text, args=(cmd_prompt,), timeout_duration=PROCESS_TIMEOUT_SEC,
                                       default=False)
    ...
    def storbinary(self, cmd=None, file_handle=None, blocksize=None, callback=None):
        ...
        if expected_duration < 5:
            ...
            cmd_prompt = 'psftp>'
            # --> use timeout on wait4prompt function
            prompt_found = timeout(self._wait_for_text, args=(cmd_prompt,), timeout_duration=expected_duration,
                                   default=False)
    ...
    def dir(self, argument='.', return_as_str=False):
        ...
        # --> use timeout on wait4prompt function
        text_found = timeout(self._wait_for_text, args=(wait_for_text,), timeout_duration=PROCESS_TIMEOUT_SEC,
                             default=False)
